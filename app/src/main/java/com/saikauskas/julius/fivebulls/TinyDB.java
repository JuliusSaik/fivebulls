...
public class TinyDB {
    ...
    public ArrayList<StockItem> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<StockItem> objects =  new ArrayList<StockItem>();

    	for(String jObjString : objStrings){
    		StockItem value  = (StockItem) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public <T> T getObject(String key, Class<T> classOfT){
        ...
        StockIntrinsicValues value = (StockIntrinsicValues) new Gson().fromJson(json, classOfT);
        if (value == null)
            return null;
        return (T)value;
    }
   ...
   public void putObject(String key, Object obj){
    ...
    public void putListObject(String key, ArrayList<StockItem> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(StockItem stock : objArray){
    		objStrings.add(gson.toJson(stock));
    	}
